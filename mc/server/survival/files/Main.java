...
extends JavaPlugin
{
	...
	public static String[] AUTHORS = {"Eh1de", "misspill", "ProseczeqPL"};
	...
	private void registerEvents() 
	{
		...
		registerEvent(new RegainHealth());
		registerEvent(new PlayerDamage());
	}
	...
	public void onEnable() 
	{
		...
		DataManager.getInstance().getLocal(null).handleGangs();
